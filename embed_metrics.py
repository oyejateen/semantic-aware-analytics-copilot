...
def run_pipeline():
    ...
    if not os.path.exists(yaml_path):
        ...
        if not os.path.exists(yaml_path):
            ...
            print("Please check your sidebar and verify the exact folder name and file location!")
            return
    ...
    print("✅ Pipeline execution successful! Your 'metrics_store' database is ready inside the ./chroma_db folder.")
